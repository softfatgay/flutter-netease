...
@objc class SwiftInstallPlugin: NSObject, FlutterPlugin {
      static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "plugins.want.flutter.io.InstallPlugin", binaryMessenger: registrar.messenger())
