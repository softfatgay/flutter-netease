...
KingKongModule _$KingKongModuleFromJson(Map<String, dynamic> json) {
  return KingKongModule()
    ..norColor = json['norColor'] as String
    ..background = json['background'] as String
    ..selectedColor = json['selectedColor'] as String
    ..kingKongList = (json['kingKongList'] as List)
        ?.map((e) =>
            e == null ? null : KingKongItem.fromJson(e as Map<String, dynamic>))
        ?.toList();
}
...
KingKongItem _$KingKongItemFromJson(Map<String, dynamic> json) {
  return KingKongItem()
