...
class _BrandState extends State<BrandCopy> {
      ...
      child: isLoading
          ...
          : CustomScrollView(
              ...
              slivers: <Widget>[
                ...
                buildBrandGoods(),
                SliverFooter(hasMore: brandList.length != total),
              ],
            ),
    );
  }
  ...
  _getInitdata() async {
    BrandDetailEntity brand = await Api.getBrandMsg1<BrandDetailEntity>(id: widget.arguments['id']);

    BrandListEntity brandListEntry =
        await Api.getBrandGoods1(page: page, brandId: widget.arguments['id'], size: pageSize);
    ...
    return SliverPadding(
      ...
      sliver: SliverGrid(
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 2, mainAxisSpacing: 8.0, crossAxisSpacing: 8.0, childAspectRatio: 1),
        delegate: SliverChildBuilderDelegate((BuildContext context, int index) {
          ...
          return Router.link(widget, Util.goodDetailTag, context, {'id': brandList[index].id});
  ...
  void getMoreData() async {
    ...
    BrandListEntity brandListEntry =
        await Api.getBrandGoods1(page: page + 1, brandId: widget.arguments['id'], size: pageSize);
