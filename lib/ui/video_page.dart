...
class _VideoPageState extends State<VideoPage> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(child: Scaffold(
      ...
      body: Stack(
        children: [
          Positioned(child:Icon(Icons.arrow_back_ios,color: backWhite,),top: MediaQuery.of(context).padding.top+20,left: 16,),
          Center(
            child: Container(
              child: AspectRatio(
            ...
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(16),
                    color: Colors.white),
                child: Image.asset('assets/images/video_play.png',height: 28,
                width: 28,),),
            ),
          ),
        ),
