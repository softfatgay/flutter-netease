...
SkuMapValue _$SkuMapValueFromJson(Map<String, dynamic> json) => SkuMapValue()
  ..id = json['id'] as num?
  ...
  ..itemSkuSpecValueList = (json['itemSkuSpecValueList'] as List<dynamic>?)
      ?.map((e) => ItemSkuSpecValueListItem.fromJson(e as Map<String, dynamic>))
      .toList()
...
SkuFreight _$SkuFreightFromJson(Map<String, dynamic> json) => SkuFreight()
...
BuyTitle _$BuyTitleFromJson(Map<String, dynamic> json) => BuyTitle()
  ..title = json['title'] as String?
