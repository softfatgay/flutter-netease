...
LookCollectionModel _$LookCollectionModelFromJson(Map<String, dynamic> json) {
  return LookCollectionModel()
    ..id = json['id'] as num
    ..tag = json['tag'] as String
    ..title = json['title'] as String
    ..subtitle = json['subtitle'] as String
    ..lookList = (json['lookList'] as List)
        ?.map((e) =>
            e == null ? null : LookListItem.fromJson(e as Map<String, dynamic>))
        ?.toList();
}
...
LookListItem _$LookListItemFromJson(Map<String, dynamic> json) {
  return LookListItem()
