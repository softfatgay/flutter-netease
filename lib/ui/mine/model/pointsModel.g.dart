...
PointsModel _$PointsModelFromJson(Map<String, dynamic> json) => PointsModel()
  ...
  ..pointList =
      (json['pointList'] as List<dynamic>?)?.map((e) => e as num).toList()
  ...
  ..lotteryDays =
      (json['lotteryDays'] as List<dynamic>?)?.map((e) => e as num).toList()
  ..hasDrawLottery = json['hasDrawLottery'] as bool?
  ..lotteryCount = json['lotteryCount'] as num?
  ..userSimpleInfo = json['userSimpleInfo'] == null
      ? null
      : UserSimpleInfo.fromJson(json['userSimpleInfo'] as Map<String, dynamic>)
  ...
  ..ponitBanners = (json['ponitBanners'] as List<dynamic>?)
      ?.map((e) => PonitBannersItem.fromJson(e as Map<String, dynamic>))
      .toList()
  ..exchangeModule = json['exchangeModule'] == null
      ? null
      : ExchangeModule.fromJson(json['exchangeModule'] as Map<String, dynamic>);
...
ExchangeModule _$ExchangeModuleFromJson(Map<String, dynamic> json) =>
    ExchangeModule()
      ...
      ..pointCommodities = (json['pointCommodities'] as List<dynamic>?)
          ?.map((e) => PointCommoditiesItem.fromJson(e as Map<String, dynamic>))
          .toList()
      ..exclusiveCommodities = (json['exclusiveCommodities'] as List<dynamic>?)
          ?.map((e) => PointCommoditiesItem.fromJson(e as Map<String, dynamic>))
          .toList()
...
WeekPoint _$WeekPointFromJson(Map<String, dynamic> json) => WeekPoint()
  ..title = json['title'] as String?
...
CurrentWeekPointItemVO _$CurrentWeekPointItemVOFromJson(
    ...
    CurrentWeekPointItemVO()
      ...
      ..pointCommodityVOList = (json['pointCommodityVOList'] as List<dynamic>?)
          ?.map((e) => PointCommoditiesItem.fromJson(e as Map<String, dynamic>))
          .toList()
...
PointCommoditiesItem _$PointCommoditiesItemFromJson(
        Map<String, dynamic> json) =>
...
MemLayawayVO _$MemLayawayVOFromJson(Map<String, dynamic> json) => MemLayawayVO()
  ..layawayList = (json['layawayList'] as List<dynamic>?)
      ?.map((e) => LayawayListItem.fromJson(e as Map<String, dynamic>))
      .toList();
...
PointExVirtualAct _$PointExVirtualActFromJson(Map<String, dynamic> json) =>
    PointExVirtualAct()
      ...
      ..endTime = json['endTime'] as num?
      ..actPackets = (json['actPackets'] as List<dynamic>?)
          ?.map((e) => ActPackets.fromJson(e as Map<String, dynamic>))
          .toList()
...
ActPackets _$ActPacketsFromJson(Map<String, dynamic> json) => ActPackets()
