...
//    dio.interceptors.add(CookieManager(CookieJar()));//缓存相关类，具体设置见https://github.com/flutterchina/cookie_jar
  ...
  //get请求
  static get(String url, Map params,Function successCallBack,{Function errorCallBack}) async {
    _instance = getInstance();
    _requstHttp(url, successCallBack, 'get', params, errorCallBack);
  }

   //post请求
  static post(String url, params,Function successCallBack,{Function errorCallBack}) async {
    _instance = getInstance();
    _requstHttp(url, successCallBack, "post", params, errorCallBack);
  }

   //post请求
  static postB(String baseUrl ,String url, params,Function successCallBack,{Function errorCallBack}) async {
    _instance = getInstance();
