...
### 注意事项:
>项目中使用了kotlin,androidx(编译一直提示没有使用androidx,强迫症就修改了),我本地的flutter sdk(1.12.13)升级到最新版本了,好多报错,无奈删除了封装的chewie,video_player(还没找到解决办法,安装video_player,就报错).编译不通过的,注意更改build文件
>
